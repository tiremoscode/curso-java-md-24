...
public class Pokedex {
    public static void main(String[] args) {
        ...
        PokemonPsiquico Kadabra = new PokemonPsiquico("Kadabra", 35, 10);
        ...
        System.out.println("El Pokemon " + Onix.getNombre() + " tiene " + Onix.getEdad() + " años y su nivel actual es "
                + Onix.getNivel());
        Onix.atacar();

        System.out.println("El Pokemon " + Kadabra.getNombre() + " tiene " + Kadabra.getEdad() + " años y su nivel actual es "
                + Kadabra.getNivel());
        Kadabra.atacar();
    }
}
